...
const sequelize = new Sequelize(process.env.DATAB_NAME, process.env.DATAB_USER, process.env.DATAB_PASS, {
    ...
    dialect: 'postgres', // Update to use PostgreSQL
...
app.listen(port, async () => {
    try {
        // Change 'force: true' to 'force: false' in production
        await sequelize.sync({ force: false }); // Use force: false to avoid dropping the database in production
